      ...
      <div className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div className="flex-1">
          ...
          <p className="mt-2 text-white text-[14px] sm:text-[10px] lg:text-lg italic mb-4">
            "Building scalable AI-powered full-stack products with clean architecture and practical AI."
          </p>

          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ASE | Full-Stack Developer (MERN, Next.js, FastAPI) | AI Integration | LLMs & RAG Systems | CUI '25
          </p>
